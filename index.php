...
include('includes/video_slider.php');
?>	
...
<!-- about area end  -->
                ...
                <div class="row text-center">
						<div class="col">
							<h2 class="font-weight-normal text-6 mt-2">Our <strong class="font-weight-extra-bold">Services</strong></h2>
						</div>
					</div>
					<div class="row text-center pt-1 pb-4 mt-1 mb-4">
						<div class="col-md-10 mx-md-auto">
							<h1 class="word-rotator slide font-weight-bold text-8 mb-3 appear-animation" data-appear-animation="fadeInUpShorter">
								<span>Blueocean is </span>
								<span class="word-rotator-words bg-primary">
							...
							Our clients can trust us to provide creative and innovative solutions for their needs which can help them get more business.
							</p>
						</div>
					</div>
					<div class="row mb-lg-4">
						<div class="col-lg-4 appear-animation" data-appear-animation="fadeInLeftShorter" data-appear-animation-delay="300">
							<div class="feature-box feature-box-style-2">
								...
								<div class="feature-box-info">
									<h4 class="font-weight-bold mb-2">BRAND IDENDITY</h4>
									<p>We help you create an appropriate Brand Identity for your business that helps your customer to develop an everlasting relationship with you.</p>
								</div>
							</div>
						</div>
						<div class="col-lg-4 appear-animation" data-appear-animation="fadeInUpShorter">
							<div class="feature-box feature-box-style-2">
								...
								<div class="feature-box-info">
									<h4 class="font-weight-bold mb-2">WEB DEVELOPMENT</h4>
									<p>We have an expert team which is committed for creating brilliant responsive, Dynamic or Static Websites whichever is best suitable as per the needs of our client.</p>
								</div>
							</div>
						</div>
						<div class="col-lg-4 appear-animation" data-appear-animation="fadeInRightShorter" data-appear-animation-delay="300">
							<div class="feature-box feature-box-style-2">
								...
								<div class="feature-box-info">
									<h4 class="font-weight-bold mb-2">MOBILE APPLICATIONS</h4>
					...
					<div class="row pb-5 mb-5">
						<div class="col-lg-4 appear-animation" data-appear-animation="fadeInLeftShorter" data-appear-animation-delay="300">
							<div class="feature-box feature-box-style-2">
								...
								<div class="feature-box-info">
									<h4 class="font-weight-bold mb-2">VIDEO PRODUCTION</h4>
									<p>We collaborate with highly acclaimed video production team to help our clients for their videography based requirements.</p>
								</div>
							</div>
						</div>
						<div class="col-lg-4 appear-animation" data-appear-animation="fadeInUpShorter">
							<div class="feature-box feature-box-style-2">
								...
								<div class="feature-box-info">
									<h4 class="font-weight-bold mb-2">DIGITAL ADVERTISING</h4>
									<p>Our digital advertising team articulates creative and innovative marketing strategies that help our clients to reach out to their intended customers with the exact communication at exact time through a proper channel.</p>
								</div>
							</div>
						</div>
						<div class="col-lg-4 appear-animation" data-appear-animation="fadeInRightShorter" data-appear-animation-delay="300">
							<div class="feature-box feature-box-style-2">
								...
								<div class="feature-box-info">
									<h4 class="font-weight-bold mb-2">SEO & SMM SERVICES</h4>
									<p>Our Search Engine Optimization strategies enhances the visibility of your website of various online search platforms there by giving your business a much-desired boost and trust of your customers.</p>
								</div>
							</div>
						</div>
					</div>
								...
								<div class="col">
									...
									<div class="lightbox" data-plugin-options="{'delegate': 'a', 'type': 'image', 'gallery': {'enabled': true}, 'mainClass': 'mfp-with-zoom', 'zoom': {'enabled': true, 'duration': 300}}">
										<div class="owl-carousel owl-theme stage-margin" data-plugin-options="{'items': 6, 'margin': 10, 'loop': false, 'nav': true, 'dots': false, 'stagePadding': 40}">
											<div>
												<a class="img-thumbnail img-thumbnail-no-borders img-thumbnail-hover-icon" href="img/projects/p (1).jpg">
													<img class="img-fluid" src="img/projects/p (1).jpg" alt="Project Image">
												</a>
											</div>
											<div>
												<a class="img-thumbnail img-thumbnail-no-borders img-thumbnail-hover-icon" href="img/projects/p (2).jpg">
													<img class="img-fluid" src="img/projects/p (2).jpg" alt="Project Image">
												</a>
											</div>
											<div>
												<a class="img-thumbnail img-thumbnail-no-borders img-thumbnail-hover-icon" href="img/projects/p (3).jpg">
													<img class="img-fluid" src="img/projects/p (3).jpg" alt="Project Image">
												</a>
											</div>
											<div>
												<a class="img-thumbnail img-thumbnail-no-borders img-thumbnail-hover-icon" href="img/projects/p (4).jpg">
													<img class="img-fluid" src="img/projects/p (4).jpg" alt="Project Image">
												</a>
											</div>
											<div>
												<a class="img-thumbnail img-thumbnail-no-borders img-thumbnail-hover-icon" href="img/projects/p (5).jpg">
													<img class="img-fluid" src="img/projects/p (5).jpg" alt="Project Image">
												</a>
											</div>
											<div>
												<a class="img-thumbnail img-thumbnail-no-borders img-thumbnail-hover-icon" href="img/projects/p (6).jpg">
													<img class="img-fluid" src="img/projects/p (6).jpg" alt="Project Image">
												</a>
											</div>
											<div>
												<a class="img-thumbnail img-thumbnail-no-borders img-thumbnail-hover-icon" href="img/projects/p (7).jpg">
													<img class="img-fluid" src="img/projects/p (7).jpg" alt="Project Image">
												</a>
											</div>
											<div>
												<a class="img-thumbnail img-thumbnail-no-borders img-thumbnail-hover-icon" href="img/projects/p (8).jpg">
													<img class="img-fluid" src="img/projects/p (8).jpg" alt="Project Image">
												</a>
											</div>
										</div>
									</div>
                ...
                <div class="home-intro mb-0" id="home-intro">
					<div class="container">
						...
						<div class="row align-items-center">
							<div class="col-lg-8">
								<p>
								Are you looking for digital agency for your new <span class="highlighted-word highlighted-word-animation-1 text-color-primary font-weight-semibold text-5">online business</span> ?
									<span> <i class="fa fa-phone"> </i>  Call us : 0755 - 492 8128, +91 - 9922951184 </span>
								</p>
							</div>
							<div class="col-lg-4">
								<div class="get-started text-left text-lg-right">
									<a href="tel:9922951184" class="btn btn-primary btn-lg text-3 font-weight-semibold px-4 py-3">Call Now!</a>
...
<div class="row counters counters-sm py-4 mt-1">
						...
						<div class="row">
							<div class="col">
								...
								<div style="padding:10px 30px;">
										<img class="img-fluid" src="img/client/a (2).png" alt="">
									</div>
									<div style="padding:10px 30px;">
										<img class="img-fluid" src="img/client/a (3).png" alt="">
									</div>
									<div style="padding:10px 30px;">
										<img class="img-fluid" src="img/client/a (4).png" alt="">
									</div>
									<div style="padding:10px 30px;">
										<img class="img-fluid" src="img/client/a (5).png" alt="">
									</div>
									<div style="padding:10px 30px;">
										<img class="img-fluid" src="img/client/a (6).png" alt="">
									</div>
									<div style="padding:10px 30px;">
										<img class="img-fluid" src="img/client/a (7).png" alt="">
									</div>
									<div style="padding:10px 30px;">
										<img class="img-fluid" src="img/client/a (8).png" alt="">
									</div>
									<div style="padding:10px 30px;">
										<img class="img-fluid" src="img/client/a (9).png" alt="">
									</div>
								</div>
							</div>
						</div>
