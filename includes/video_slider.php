						...
						<ul>
							<li class="slide-overlay" data-transition="fade">
								...
								<div class="rs-background-video-layer" 
									...
									data-videomp4="video/myvideo1.mp4" 
								...
								<div class="tp-caption"
									...
									data-transform_idle="opacity:0.2;s:500;" style="z-index: 5;"><img src="#" alt=""></div>
								...
								<div class="tp-caption text-color-light font-weight-normal"
									...
									data-transform_in="y:[-50%];opacity:0;s:500;" style="z-index: 5;">GET READY TO SEE</div>
								...
								<div class="tp-caption d-none d-md-block"
									...
									data-y="center" data-voffset="['-33','-33','-33','-55']" style="z-index: 5;"><img src="#" alt=""></div>
								...
								<div class="tp-caption font-weight-light"
									...
									style="color: #b5b5b5; z-index: 5;">Check out our options and features</div>
